...
problem_description = st.text_area("Enter the problem you are facing:")

st.subheader("Root Cause Analysis")
selected_method = st.selectbox("Select a method for root cause analysis:", ["5 Whys", "Fishbone Diagram", "Pareto Analysis"])
...
save_name = st.text_input("Enter a file name to save results:")
if st.button("Save"):
    if save_name:
        results = {
